...
public:
	...
	Local_Variable* create_local_variable(char*);//add colNo & LineNo
	Data_Member* create_data_member(char*, Access_Modifier*, Data_Storage*);//add colNo & LineNo
