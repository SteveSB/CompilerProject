...
variable_declarator
  : T_IDENTIFIER
  | T_IDENTIFIER T_EQUAL variable_initializer
  ;
...
constant_declarators
  ...
  ;
constant_declarator
  : T_IDENTIFIER T_EQUAL constant_expression
  ;
expression_statement
...
qualified_identifier
  : T_IDENTIFIER
  | qualifier T_IDENTIFIER
  ;
qualifier
  : T_IDENTIFIER T_DOT 
  | qualifier T_IDENTIFIER T_DOT 
  ;
namespace_body
...
using_directive
  ...
  ;
using_alias_directive
  : T_USING T_IDENTIFIER T_EQUAL qualified_identifier T_SEMICOLON
  ;
using_namespace_directive
...
/***** C.2.7 Structs *****/
struct_declaration
  : attributes_opt modifiers_opt T_STRUCT T_IDENTIFIER struct_interfaces_opt struct_body comma_opt
  ;
